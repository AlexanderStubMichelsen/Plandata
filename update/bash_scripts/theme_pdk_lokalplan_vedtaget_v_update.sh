...
SERVER_LAYER="pdk:theme_pdk_lokalplan_vedtaget_v"
LOCAL_LAYER="theme_pdk_lokalplan_vedtaget_v"
...
if [[ -f "../../master_scripts/update/update_logs_and_error_etc/last_download.txt" ]]; then
    ...
    echo "Error: last_download.txt not found." >> ../../master_scripts/update/update_logs_and_error_etc/error_log.txt
    exit 1
fi
