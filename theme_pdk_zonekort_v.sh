...
SERVICE_PARAMS="servicename=wfs&request=getcapabilities&service=wfs&typename=pdk:pdk:theme_pdk_zonekort_v"

# Specify the layer you want to update
SERVER_LAYER="pdk:theme_pdk_zonekort_v"
LOCAL_LAYER="theme_pdk_zonekort_v"
