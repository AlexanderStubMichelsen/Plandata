...
CREATE_TABLE_SQL="
CREATE TABLE IF NOT EXISTS plandata_hash.theme_pdk_lokal_forslag_hashed_values (
...
INSERT_HASH_SQL="
INSERT INTO plandata_hash.theme_pdk_lokal_forslag_hashed_values (row_hash)
SELECT md5(
...
FROM plandata.theme_pdk_lokalplan_forslag_v;
"
