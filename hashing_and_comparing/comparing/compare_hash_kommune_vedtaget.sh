...
FROM plandata_hash_old.theme_pdk_kommune_vedtaget_hashed_values_old old
LEFT JOIN plandata_hash.theme_pdk_kommune_vedtaget_hashed_values new
...
FROM plandata_hash.theme_pdk_kommune_vedtaget_hashed_values new
LEFT JOIN plandata_hash_old.theme_pdk_kommune_vedtaget_hashed_values_old old
